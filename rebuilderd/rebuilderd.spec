...
# worker rebuild helper scripts
install -Dm 755 -t %buildroot/%{_libexecdir}/rebuilderd worker/rebuilder-fedora.sh
...
install -p -D -m 0644 %{SOURCE5} %{buildroot}/%{_unitdir}/%{name}-worker@.service
